...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      <div className="intro">
        <h2 className="style-para" style={style.color}>
      ...
      <div className="contact-info">
        ...
        <div className="row">
          ...
          <span className="style-span opacity-8">syria,Damascus</span>
        </div>
        <div className="row">
          <GeoAltFill fontSize="30px" color={color} />
          <p className="style-para">Email</p>
          <span className="style-span opacity-8">m.nour.kh9346@gmail.com</span>
        </div>
        <div className="row">
      ...
      <div className="section-sendEmail">
        <div className="intro-email">
          <h2 style={style.color} className="style-para">
            send me an email
          </h2>
        ...
        <div className="contact">
          ...
          <button style={style.backgroundColor} className="button">
            Send massage
          </button>
        </div>
      </div>
