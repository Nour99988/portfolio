    ...
    >
      <div className="content-home">
        <div className="content-info">
          ...
          <p className="style-title">hello my name is Mohammed Khattab</p>
          <p className="style-title">
            I am a
            <span style={style.color}>
              <Typewriter
                words={[" FrontEnd Developer", " BackEn", " UnKnow", " end"]}
                loop
                cursor
                cursorStyle="|"
                typeSpeed={70}
          ...
          <p className="style-para opacity-8">
            An innovative frontend developer. Pursuit may passion for a high level of success, Maintains up to date
            awareness of technological trends and technological advances.
          </p>
          <motion.button
